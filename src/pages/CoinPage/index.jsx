          ...
          <section>
            ...
            <div className="content">
              <div className="section">
                ...
                <p>Mỗi 1 COIN trong tài khoản có giá trị tương đương 1000 đ.</p>
                <h3>
                  <strong>Giá trị quy đổi thế nào?</strong>
                </h3>
                <p>Mỗi 1 COIN trong tài khoản có giá trị tương đương 1000 đ.</p>
              ...
              <div className="section">
                ...
                <p>
                  - Là học viên đã tham gia một hoặc nhiều khoá học tại
                  Spacedev.
                </p>
                <p>
                  - Mỗi khi có học viên mới đăng ký khoá học thành công (được
                  xác nhận thành công từ đội ngũ Spacedev) tài khoản học viên
                  giới thiệu sẽ được cộng một số điểm COIN tương ứng tùy từng
                  khóa học (mỗi điểm có giá trị tương ứng 1000 đ).
                </p>
                <p>
              ...
              <div className="section">
                ...
                <p>
                  ...
                  đăng ký trực tuyến tại website của Spacedev qua link giới
                  thiệu.
                </p>
              </div>
            </div>
