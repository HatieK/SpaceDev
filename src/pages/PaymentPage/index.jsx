            ...
            <div className="content">
              <div className="section">
                ...
                <p>
                  ...
                  khoản của Spacedev và sẽ không chịu trách nhiệm hay hoàn trả
                  học phí khi có sai sót trong quá trình chuyển khoản hoặc sai
                  thông tin chuyển khoản. Nếu xảy ra sai sót, Bạn vui lòng làm
                  việc với ngân hàng để được xử lí.
                </p>
                <p>
                  ...
                  thoại mã khóa học (ví dụ: Nguyen Tuan Anh 0989998881
                  Spacedev2)
                </p>
                <p>
                  <i>
                    Sau khi thanh toán và Spacedev nhận được tiền sẽ chủ động
                    nhắn tin để xác nhận.
                  </i>
                </p>
                <h3>
                ...
                <p>
                  ...
                  gia khóa Spacedev OFFLINE. Thanh toán ngày đầu tiên khi tham
                  gia khóa học.
                </p>
              </div>
              <div className="section">
